...
DECLARE 
	...
	_the_table TEXT := 'cyclist_facilities';
BEGIN
    ...
    EXECUTE ' INSERT INTO '||quote_ident(_the_table)||' (the_geom, name, address, type_of_facility)
            VALUES ($1, $2, $3, $4)
            ' USING _the_geom, _name, _address, _type_of_facility;
